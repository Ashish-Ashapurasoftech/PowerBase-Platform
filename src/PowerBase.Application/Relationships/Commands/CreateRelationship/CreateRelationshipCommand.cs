...
public record CreateLookupSpec(int SourceFid, string Name, string? Label, string? SourceSubField = null);
...
public record CreateSummarySpec(string Name, string? Label, string Function, int? TargetFid, string? TargetSubField = null);
