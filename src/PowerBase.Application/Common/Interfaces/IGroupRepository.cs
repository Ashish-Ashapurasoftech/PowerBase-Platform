...
public interface IGroupRepository
{
    ...
    Task<(IEnumerable<GroupDto> Items, int TotalCount)> ListPagedAsync(string? search, int page, int pageSize, string sortBy = "name", bool sortDesc = false, CancellationToken ct = default);
